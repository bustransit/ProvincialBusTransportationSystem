 ...
 */
package bus_transit.hr.training.reports;
...
public class ReportViewer extends javax.swing.JFrame {
    ...
    public void showReport(){
        ...
        JasperReport jr;
        try {
            jr = JasperCompileManager.compileReport("C:\\Users\\NelsonDelaTorre\\Documents\\NetBeansProjects\\Bus_Transit-master\\src\\bus_transit\\hr\\training\\reports\\Training.jrxml");
            JasperPrint jrp = JasperFillManager.fillReport(jr, null, db.connection); 
            JRViewer viewer = new JRViewer(jrp);            
            this.add(viewer);
