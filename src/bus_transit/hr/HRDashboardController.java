...
public class HRDashboardController implements Initializable {   
    ...
    public void loadSidePane(){
        ...
        try {
            //AnchorPane pane = FXMLLoader.load(getClass().getResource("HRSidePane.fxml"));           
            AnchorPane pane = FXMLLoader.load(getClass().getResource(dir.HRSidePane.getPath()));
    ...
    private void SignOut(ActionEvent event) {
        ...
        btn_yes.setOnAction((evt) -> {
            try {
                ...
                Logger.getLogger(HRDashboardController.class.getName())
